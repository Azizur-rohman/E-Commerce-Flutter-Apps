                ...
                child: Column(
                  children: [
                    ...
                    FutureBuilder<QuerySnapshot>(
                      ...
                      builder: (c, dataSnashot)
                      {
                        return dataSnashot.hasData
                            ? OrderCard(
                          itemCount: dataSnashot.data.documents.length,
                          data: dataSnashot.data.documents,
                        )
...
class AdminShippingDetails extends StatelessWidget {
        ...
        Padding(
          ...
          child: Center(
            child: InkWell(
              onTap: ()
              {
                confirPercelShifted(context, getOrderId);
              },
              child: Container(
                decoration: new BoxDecoration(
                  gradient: new LinearGradient(
  ...
  confirPercelShifted(BuildContext context, String mOrderId)
  {
    ...
    Fluttertoast.showToast(msg: "Order parcel has been shifted. Confirmed.");
  }
