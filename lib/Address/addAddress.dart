...
class AddAddress extends StatelessWidget
{
  ...
  final cFlatorHomeNumber = TextEditingController();
           ...
           if(formkey.currentState.validate())
             {
               final model = AddressModel(
                 ...
                 flatNumber: cFlatorHomeNumber.text,
               ...
               .collection(EcommerceApp.subCollectionAddress)
                   ...
                   .setData(model)
               .then((value){
                 final snack = SnackBar(content: Text("New Address added successfull."));
